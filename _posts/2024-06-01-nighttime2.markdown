...
The [figure below summarises the key points](https://nikefn.github.io//assets/images/blog-night/noct-ecosocio.jpg) drawn from the publications I read in the process of getting acquainted with the overall topic of nighttime socioeconomics and nighttime ecology[^18] [^5]. The mentioned arguments made a lasting impression on me and I tried summarising their essence in the following[^19].
