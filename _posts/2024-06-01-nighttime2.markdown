...
I spend most of my working time on projects on sustainable city development. Whenever I bring up the topic of the urban night in this professional context, I often encounter a certain mix of reactions: Usually either a grin or a confused look. A reaction that seems to ask, *"this is a fun topic, but what exactly is the connection to what we're doing here?“*. Being in a *professional* context, people want talk about *professional* topics. These reactions suggests a perception that night is a leisure time, separate from *'serious'* urban issues.
...
Much like in my previous blogpost, I want to challenge that notion with a bold claim: ***What if the after-work hours are precisely when we can best address some of the most pressing urban challenges?***
...
1.  **To tackle the global challenges we face, we need creativity and a willingness to break away from old patterns - qualities that are often more accessible in the after working hours, when we can easier move away from the constraints of formal professional settings.**

2. **The underlying reasons sustainable/green city development and cultural engagement/nightlife aren't central to mainstream urban planning are similar: Ill-fitted metrics. If the underlying reasons resemble, overlaps should be able to be identified; consequently addressing one could inform and enhance the other. Synergies should exist and/or be able to developed.**

3. **Ultimately, might not the disconnect between after-work life and the sustainable city development agenda be a major factor what's slowing our progress towards major urban transitions?**
...
The diagram above summarises the key points drawn from the three publications given in the following. These points made a lasting impression on me; however, please note that this summary is not exhaustive. These publications offer a broad range of examples and arguments that enrich our understanding of this topic.

From a societal perspective, the book "Managing Cities at Night: A Practitioner Guide to the Urban Governance of the Night-Time Economy" by Michele et al., published in 2022, provides a comprehensive overview. It highlights a common trait among urban planners, policymakers, and researchers: Most prefer daytime for their professional activities, often neglecting night-time considerations once their workday ends.

In ecology, two articles by Kevin J. Gaston resonated deeply with me: "Nighttime Ecology: The 'Nocturnal Problem' Revisited" (2019) and "Anthropogenic Changes to the Nighttime Environment" (2023). Interestingly, the key observations in those articles are applicable to both ecological and socioeconomic aspects of nighttime, when reading 'ecology' just replace it with 'socioeconomics' in your head and think if this makes sense:
