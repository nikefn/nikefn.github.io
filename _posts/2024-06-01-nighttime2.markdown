...
The [figure below summarises the key points](https://nikefn.github.io//assets/images/blog-night/noct-ecosocio.jpg) drawn from the publications I read in the process of getting acquainted with the overall topic of nighttime socioeconomics and nighttime ecology[^5] [^18]. The mentioned arguments made a lasting impression on me and I tried summarising their essence in the following[^19].
...
Societal Perspective[^4] [^6] [^18] [^19]: What struck me most was a frequently described and seemingly common pattern among urban planners, policymakers, and researchers alike: Most prefer daytime for their professional activities, often neglecting night-time considerations once their workday ends.
