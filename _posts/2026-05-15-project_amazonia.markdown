...
This is the starting point for the Amazonia City Lab Initiative.

[^1]: Sources: [IDB Amazonian Cities Forum](https://blogs.iadb.org/ciudades-sostenibles/en/world-cities-day-amazonian-cities-forum-sustainable-development/); [Pulitzer Center: "The Amazon Rainforest Is Urban, Too"](https://pulitzercenter.org/stories/amazon-rainforest-urban-too); [Science Panel for the Amazon: Sustainable Cities Policy Brief](https://eng-briefs.sp-amazon.org/251126%20SUSTAINABLE%20CITIES%20POLICY%20BRIEF%20ENG.pdf).

---

## The initiative: Bringing Morgenstadt to the Amazon

The [Morgenstadt Initiative](https://www.morgenstadt.de/en.html) at Fraunhofer has worked with over 100 partner cities across four continents. Its [City Lab methodology](https://www.morgenstadt.de/content/dam/morgenstadt/en/documents/Morgenstadt%20City%20Labs_EN.pdf) combines systems analysis with co-creation: Researchers and local stakeholders jointly diagnose the status quo, develop a strategic roadmap, and identify priority projects. The method showed to be successful in the past, because it insists on equal footing between external expertise and local knowledge. Qualitative dimensions like community cohesion, cultural practices and governance capacity carry the same weight as quantitative infrastructure data.

In 2024, a consortium of [Fraunhofer IAO](https://www.iao.fraunhofer.de/), [Amazonia 4.0 / AmIT](https://amazonia4.org/) and [Fundação Getulio Vargas (FGV)](https://portal.fgv.br/en) began to explore whether this methodology could be adapted with and for small towns in the Brazilian Amazon. The premise was simple: These towns often have strong local motivation and active grassroots initiatives, but lack the technical capacity and institutional bridges to scale what they have already started. The question was whether a co-creative research partnership could help close that gap, without imposing solutions from outside.
...
## The Vision: A Community-Owned Eco-Factory

In direct response to this locally identified gap, ACLI and the Novo Airão stakeholders jointly designed the concept for a community-owned, open-source plastics recycling and upcycling Eco-Factory. The idea is a small-scale facility where commonly recoverable household plastics are sorted, cleaned, shredded and converted into usable materials and products, from pressed sheets and panels to 3D-printed utility items for local services, tourism and education.
...
In January 2026, we successfully submitted our ACLI concept note to the [International Climate Initiative (IKI)](https://www.international-climate-initiative.com/en/) of the German Federal Ministry for the Environment and Consumer Protection. The proposed budget is €800,000 over 26 months.

A total of 296 project outlines were submitted in this round and while our concept has strong endorsement, funding is anything but certain.

Regardless of the outcome, we continue to explore additional funding vehicles alongside our local partners. The underlying question guiding our work remains: how can applied research institutions contribute meaningfully to places where sustainability challenges are most pressing, without replicating patterns of one-directional knowledge transfer?

Also regardless of the outcome, working on this initiative and outline has been one of the most personally rewarding things I’ve done during my time at Fraunhofer IAO.
