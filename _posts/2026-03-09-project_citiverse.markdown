...
**The tangible side** is what gets measured: GDP, traffic flow, housing costs, energy consumption. These indicators are the foundation of decision-making because they are comparable, aggregable and fit well into dashboards. The higher up in a management hierarchy you go, the more things you need to take into account, the greater the pressure to simplify, and the greater the reliance on indicators that can turn complex reality into a single number.
...
The trouble is that we know the tangible side alone falls short. It can tell you how many people use a park but not whether the park feels safe. It can measure housing costs but not whether a neighbourhood feels like home. So over time, the field has responded by developing new, more nuanced indicators that try to capture what the conventional ones miss - e.g. liveability indices, social cohesion scores, walkability metrics, perceived safety surveys and hundreds more. My colleague Aapo Huovila documented [over 1,500 smart and sustainable city indicators](https://cris.vtt.fi/en/publications/evaluation-of-smart-and-sustainable-city-development-what-indicat) in his dissertation. This sheer number is not a sign of failure; it reflects a genuine effort to make the intangible measurable. But it raises a question I keep coming back to: Does this proliferation follow a pattern?

![Open Question: Does a cycle like the following exist?](/assets/images/proj-work/citiverse/metrics_cycle.jpg)

**Open Question: Does a cycle like the following exist?** *The slide shows a hypothetical four-step cycle: A complex urban question arises that existing or conventional indicators cannot adequately capture, the available indicators from e.g. official UN/EU-indicator spreadsheets are too broad or generic for local context -> Local practitioners develop new, context-specific indicators to fill the gap, adding to a growing total ->   Over time, governing bodies seek consolidation and produce standardised lists, which are again too broad for local context -> the cycle restarts. Whether this loop exists systematically is an open question. The pattern of proliferation itself is observable.[^7]*
